...
module.exports = {
  content: [
    ...
    './node_modules/@fleetbase/flb-*-extension/addon/**/*.{hbs,js}',
    './node_modules/@fleetbase/flb-*-extension/addon/**/*.{hbs,js}',
    './node_modules/**/flb-*-extension/addon/**/*.{hbs,js}',
  ],
  theme: {
    extend: {
      colors: {
      ...
      boxShadow: {
        ...
        light:
          '0 1px 3px 0 rgba(212,220,236, 0.1), 0 1px 2px 0 rgba(212,220,236, 0.06)',
        'light-md':
          '0 4px 6px -1px rgba(212,220,236, 0.1), 0 2px 4px -1px rgba(212,220,236, 0.06)',
        'light-lg':
          '0 10px 15px -3px rgba(212,220,236, 0.1), 0 4px 6px -2px rgba(212,220,236, 0.05)',
        'light-xl':
          '0 20px 25px -5px rgba(212,220,236, 0.1), 0 10px 10px -5px rgba(212,220,236, 0.04)',
